...
//        //get account and transaction service beans
        ...
        Account receiver1 = accountService.createNewAccount(BigDecimal.valueOf(500), new Date(), AccountType.CHECKING, 3L);
        Account receiver2 = accountService.createNewAccount(BigDecimal.valueOf(200), new Date(), AccountType.CHECKING, 4L);
//
